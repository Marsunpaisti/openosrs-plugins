...
open class BootstrapTask : DefaultTask() {
    ...
    private fun getBootstrap(): JSONArray? {
        ...
        val url = "https://raw.githubusercontent.com/marsunpaisti/plugins-release/master/plugins.json"
            ...
            project.subprojects.forEach {
                if (it.project.properties.containsKey("PluginName") && it.project.properties.containsKey("PluginDescription")) {
                    ...
                    releases.add(JsonBuilder(
                            ...
                            "url" to "https://github.com/marsunpaisti/plugins-release/blob/master/release/${it.project.name}-${it.project.version}.jar?raw=true",
                    ...
                    val pluginObject = JsonBuilder(
                            ...
                            "provider" to "Paisti",
                            "projectUrl" to "https://discord.gg/9fGzEDR",
