...
public class PathAnalyzer {
    ...
    public static RealTimeCollisionTile closestTileInPathToPlayer(List<RSTile> path) {
        ...
        closestToPlayer = (RealTimeCollisionTile) BFS.bfsClosestToPath(path, RealTimeCollisionTile.get(playerPosition.getX(), playerPosition.getY(), PPlayer.location().getPlane()));
