...
import net.runelite.client.plugins.paistisuite.api.WebWalker.api_lib.json.ParseException;
import net.runelite.client.plugins.paistisuite.api.WebWalker.api_lib.models.*;
import net.runelite.client.plugins.paistisuite.api.WebWalker.api_lib.utils.IOHelper;
...
public class WebWalkerServerApi{
    ...
    private List<PathResult> parseResults(ServerResponse serverResponse){
        ...
        try {
            ...
            log.error("Error: " + pathResult.getPathStatus());
